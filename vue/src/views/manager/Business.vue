  ...
  <div>
    ...
    <div class="table">
      <el-table :data="tableData" strip @selection-change="handleSelectionChange">
        ...
        <el-table-column label="店铺头像" align="center">
          <template v-slot="scope">
            <div style="display: flex; align-items: center; justify-content: center;">
              <el-image style="height: 40px; " v-if="scope.row.avatar"
        ...
        <el-table-column prop="description" label="店铺介绍" align="center" show-overflow-tooltip></el-table-column>
    ...
    <el-dialog title="商家" :visible.sync="fromVisible" width="40%" :close-on-click-modal="false" destroy-on-close>
      <el-form :model="form" label-width="100px" style="padding-right: 50px" :rules="rules" ref="formRef">
        ...
        <el-form-item prop="description" label="店铺介绍">
