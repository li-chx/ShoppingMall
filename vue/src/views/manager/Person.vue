  ...
  <div>
    <el-card style="width: 50%">
      <el-form :model="user" label-width="100px" style="padding-right: 50px">
        ...
        <el-form-item label="姓名" prop="name" v-if="user.role === 'ADMIN'">
          <el-input v-model="user.name" placeholder="姓名"></el-input>
        </el-form-item>
        <el-form-item label="店铺名" prop="name" v-if="user.role === 'BUSINESS'">
        ...
        <el-form-item label="店铺介绍" prop="description" v-if="user.role === 'BUSINESS'">
          <el-input type="textarea" v-model="user.description" placeholder="店铺介绍"></el-input>
        </el-form-item>
        <el-form-item label="审核状态" prop="status" v-if="user.role === 'BUSINESS'">
